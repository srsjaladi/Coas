...
-(void)launchChatForContact:(NSString *)contactId  withChannelKey:(NSNumber*)channelKey
{
    ...
    NSMutableArray *viewControllersFromStack = [NSMutableArray arrayWithArray:[self.navigationController viewControllers]];
    for (UIViewController *currentVC in viewControllersFromStack)
    {
        ...
        if([currentVC isKindOfClass:NSClassFromString([ALApplozicSettings getMsgContainerVC])])
        {
